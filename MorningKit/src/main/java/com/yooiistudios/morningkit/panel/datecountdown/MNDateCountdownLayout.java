 ...
 */
public class MNDateCountdownLayout extends MNPanelLayout {
    ...
    public MNDateCountdownLayout(Context context) {
        super(context);
    }

    public MNDateCountdownLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
