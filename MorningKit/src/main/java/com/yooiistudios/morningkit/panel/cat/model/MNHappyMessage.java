...
/**
 * Created by Wooseong Kim in MorningKit from Yooii Studios Co., LTD. on 2014. 9. 3.
 *
 * MNHappyMessage
 *  고양이 애니메이션 후 보여주는 메시지 클래스
 */
public class MNHappyMessage {
    public String happyMessageString;
    public int previousIndex = -1;

    public static final String[] happyMessages = {
            "Have a nice day!",
            "Mew~",
            "YaOng~",
            "Be positive!",
            ...
            "Come to me if you are in any difficulty.",
            ...
            "Come out and say it.",
            "Please don't brood over such a trivial matter.",
