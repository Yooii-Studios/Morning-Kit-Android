...
{
	private static String TAG = "MNExchangeInfo";
	...
	//private double targetCurrencyMoney;			// 금액		targetCountry의 금
	...
	static public String getMoneyString(double _money)	
	{
		NumberFormat format = NumberFormat.getCurrencyInstance();

		
		String result = format.format(_money);
