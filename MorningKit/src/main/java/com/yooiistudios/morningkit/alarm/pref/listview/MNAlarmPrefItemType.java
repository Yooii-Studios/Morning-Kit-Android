...
//    public int getIndex() { return index; }
    ...
    public static MNAlarmPrefItemType valueOf(int index) {
        ...
        switch (index) {
            ...
            default: throw new AssertionError("Undefined Index Enumeration");
        }
    }
}
