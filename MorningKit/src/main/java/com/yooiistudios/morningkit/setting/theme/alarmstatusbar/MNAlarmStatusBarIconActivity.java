...
public class MNAlarmStatusBarIconActivity extends MNSettingDetailActivity {
    private static final String TAG = "AlarmStatusBarIconActivity";
    @InjectView(R.id.setting_theme_alarm_status_icon_container) RelativeLayout backgroundLayout;
...
//        backgroundLayout.setBackgroundColor(0xff4444dd);
        backgroundLayout.setBackgroundColor(
                MNSettingColors.getBackwardBackgroundColor(MNTheme.getCurrentThemeType(this)));
...
//            transaction.setCustomAnimations(R.anim.fragment_enter, 0);
            ...
            transaction.replace(R.id.setting_theme_alarm_status_icon_container,
                    MNAlarmStatusBarIconFragment.newInstance());
